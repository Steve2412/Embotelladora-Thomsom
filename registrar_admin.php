...
<section class="courses">
      ...
      <h1>Ingrese los datos para registrar un Administrador</h1> <br><br>
...
<script>
   $(document).ready(function(){
      ...
      $(document).on('click','#crear_cliente',function(){
            ...
            if(Cedula != ''|| Nombre != ''|| Correo != ''|| Telefono != '' || Direccion != ''|| Contra != ''){
                $.ajax(
                    {
                    url:"action.php",
                    type:"POST",
                    data:{Cedula:Cedula,Nombre:Nombre,Correo:Correo,Telefono:Telefono,Direccion:Direccion,Contra:Contra,action:action},
